...
class ClipartDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        """Dataset for Clipart data.
        Args:
            data_dir: the root of the Clipart1k dataset, the directory contains the following sub-directories:
                Annotations, ImageSets, JPEGImages, NO[SegmentationClass, SegmentationObject].
        """

...
class MyCustomTransform(object):
    ...
    def __call__(self, image, boxes=None, labels=None):
        ...
        if random.random() < self.probability:
          ...
          image = self.transform_image(image).numpy()
          image = image[0, :, :, :]
    ...
    def transform_image(self, image ):
        ...
        style = rfile.choice(os.listdir("/content/SSD/datasets/clipart/JPEGImages"))
        style = Image.open("/content/SSD/datasets/clipart/JPEGImages/"+style)
